    ...
    return (
      <div className="">
        ...
        <div className="container">
          <div className="px-0 bg-light jumbotron mt-5">
            <div className="row">
              <div className="col-sm-12 col-md-12 col-lg-6">
                <div className="subheading mb-3">
                  <span>WORK FROM HOME</span>
                </div>
                <h1 className="h1 mb-3 text-left">
            ...
            <div className="row">
              <div className="col-lg-4 ">
                <div>
                  ...
                  <h6 className="h6 my-4 text-left">
                    Conversations, organized
                  </h6>
                  <p>
                    Instead of a single overstuffed inbox, conversations in Our
                    App happen in dedicated spaces called channels.
                  </p>
                </div>
              </div>
              <div className="col-lg-4 py-5 py-lg-0">
                <div>
                  ...
                  <h6 className="h6 my-4 text-left">Get looped in, not out</h6>
                  <p>
                    Our App makes it simple to follow conversations or find
              ...
              <div className="col-lg-4">
                <div>
                  ...
                  <h6 className="h6 my-4 text-left">Give focus a chance</h6>
                  <p>
                    Unlike email, Our App lets you choose which conversations
        ...
        <div className="container">
          <section className="app-section details-bx">
            <div className="row align-items-center">
              <div className="col-lg-6 ">
                <div className=" details">
                  <h2 className="h2 text-left">Make the change to channels</h2>
                  <p className="lead">
                    Productive teamwork happens in channels — organized spaces
              ...
              <div className="col-lg-6 mb-4">
                <div className="">
                  <video
                    aria-describedby="organize-your-work-alt"
                    autoPlay=""
                    loop=""
                    muted=""
                    playsInline=""
                  ...
                  >
                    <source
                      src="https://a.slack-edge.com/d6bad/marketing/img/features/channels/video/inline-1/channels-inline1.mp4"
                      type="video/mp4"
                    />
                    <source
                      src="https://a.slack-edge.com/1ebb1/marketing/img/features/channels/video/inline-1/channels-inline1.webm"
                      type="video/webm"
                    />
                  </video>
                </div>
          ...
          <section className="app-section details-bx">
            <div className="row align-items-center">
              <div className="col-lg-6">
                <div>
                  {/* <video
                    src="shared-channels-inline3.mp4"
                    className="img-fluid"></video>
                  // >*/}
                  <video
                    aria-describedby="build-trust-alt"
                    autoPlay=""
                    loop=""
                    muted=""
                    playsInline=""
                  ...
                  >
                    <source
                      src="https://a.slack-edge.com/d6bad/marketing/img/features/shared-channels/videos/inline-3/shared-channels-inline3.mp4"
                      type="video/mp4"
                    />
                    <source
                      src="https://a.slack-edge.com/1ebb1/marketing/img/features/shared-channels/videos/inline-3/shared-channels-inline3.webm"
                      type="video/webm"
                    />
                  </video>
                </div>
              ...
              <div className="col-lg-6">
                <div className="details">
                  <h2 className="h2 text-left">
                    Our App Connect brings companies together
                  </h2>
                  <p>
                  ...
                  <a href="">
                    <span>
                      See how to with Our App <i className="fa fa-arrow-right"></i>
                    </span>
                  </a>
                </div>
              </div>
        ...
        <div className="container">
          <div className="text-center mb-4">
            ...
            <a href="">
              See all customer stories <i className="fa fa-arrow-right"></i>
            </a>
          </div>
          <Slider {...settings}>
            <div>
              <div className="p-5">
                <div className=" carousel d-flex shadow-lg">
                  <div className="img-cont">
                    <img
                      src="slack-customer-intuit.jpg"
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      Some Lorem Ipsum Text because i"m out of options
                    </p>
                    <a
                      href="#"
                      className="text-primary text-uppercase d-flex justify-content-between mt-5 learn-more-link"
                    >
            ...
            <div>
              <div className="p-5">
                <div className="carousel d-flex shadow-lg">
                  <div className="img-cont">
                    <img
                      src="slack-customer-shopify.jpg"
                      className="card-img-top p-0 img-fluid"
                      alt="..."
                    />
                  </div>
        ...
        <div className="container">
          <section className="app-section">
            <h3 className="display-5 mb-5 text-center">Whats new ?</h3>
            <div className="row card-deck">
              <div className="col-sm-12 col-md-12 col-lg-4 mb-5 px-5 px-lg-0">
                <div className="card">
                  {/* <a href="#"> */}
                    <div>
                    <img
                      src="img-promo-remote-work.jpg"
                    ...
                    <div className="card-body">
                      ...
                      <a
                        ...
                        className="text-primary text-uppercase d-flex justify-content-between mt-5 learn-more-link"
                      >
                        learn more <i className="fa fa-arrow-right ml-auto"></i>
                      </a></div>
                    </div>
                  {/* </a> */}
                </div>
              ...
              <div className="col-sm-12 col-md-12 col-lg-4 mb-5 px-5 px-lg-0">
                <div className="card">
                  {/* <a href="#"> */}
                    <img
                      src="gsuite-calendar-email-files.png"
                      className="card-img-top p-2 img-fluid"
                      alt="..."
                    />
                    <div className="card-body">
        ...
        <div>
          <section className="ftco-animate probootstrap-section bg-img bg-overlay ">
            <div className="container">
              <div className="row">
                <div className="col-md-12 text-center cta">
                  <h2 className="text-white display-4">
                    Choose a better way to work
                  </h2>
                  <p className="text-white mb-5 lead">
                    Far far away, behind the word mountains, far from the
                    countries Vokalia did we notice the overall convoseur of
                    each Lorem Ipsum text. However, nobody noticed how value
                    increased our ineptitude.
                  </p>
                  {/* <div className="row justify-content-center"> */}

                  <a href="" className="btn btn-secondary c-button">
                    Try Our App{' '}
                    {/* <i className="la la-arrow-right mini-icon"></i> */}
                  </a>
                  <a
                    href=""
                    className="btn btn-outline-danger c-button c-button-2"
                  >
                    Contact Sales{' '}
                    {/* <i className="la la-arrow-right mini-icon"></i> */}
                  </a>
